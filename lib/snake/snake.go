...
func (snake *Snake)Turn(directions ...Direction) *Snake {
  ...
  switch snake.Direction {
    case DIRECTION_TOP: c = snake.NodeList.Column.TopList
    case DIRECTION_BOTTOM: c = snake.NodeList.Column.BottomList
    case DIRECTION_LEFT: c = snake.NodeList.Column.LeftList
    case DIRECTION_RIGHT: c = snake.NodeList.Column.RightList
    case DIRECTION_EMPTY: c = snake.NodeList.Column
  }
